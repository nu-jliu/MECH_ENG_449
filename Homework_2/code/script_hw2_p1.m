...
[theta_vec, succ, ~, ea_short, el_short] = IKinBodyIterates(B_mat, M, Tsd, theta0_vec, 1000, 0.001, 0.0001, 'short_iterates');
...
[theta_vec, succ, ~, ea_long, el_long] = IKinBodyIterates(B_mat, M, Tsd, theta0_vec, 1000, 0.001, 0.0001, 'long_iterates');
